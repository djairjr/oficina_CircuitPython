'''
    ARKANOID on Neopixels - 20/06/2024
    Desenvolvido para a oficina Recriando os Clássicos em Circuitpython
    Modularizado como classe para funcionar com o sistema de menus
